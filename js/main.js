...
import AccessibilityHelper from './accessibility_helper.js';
...
/**
 * Run accessibility function to correct the tabindex for map
 */
window.onload = () => {
  AccessibilityHelper.setTabIndex();
};
...
let initMap = () => {
  ...
  L.tileLayer(
    ...
    {
      mapboxToken:
        "pk.eyJ1Ijoib21lcnRhcmlrOTYiLCJhIjoiY2ppYnhxaTh3MGtwODNwcGYwZzV4bW8xZiJ9.usxhz_a8aNN7ktS91Zzh9Q",
      maxZoom: 18,
      attribution:
...
let createRestaurantHTML = restaurant => {
  ...
  image.alt = restaurant.name + " restaurant marketing image";
  li.append(image);
